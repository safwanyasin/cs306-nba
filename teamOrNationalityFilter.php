                ...
                <div id="container" class="table-container" style="width: 100%; padding: 0px;">
                    ...
                    <table class="all-players">
                        ...
                        <?php
                            ...
                            include "config.php";
                            if ($_POST['idOrNation'] == "team_id") {
                                $team_id = $_POST['filterValue'];
                                $sql_statement = "SELECT * FROM Players WHERE team_id = '$team_id'";
                            } 
                            else {
                                $nationality = $_POST['filterValue'];
                                $sql_statement = "SELECT * FROM Players WHERE nationality = '$nationality'";
                            }
